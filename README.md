...
This application has been rebuilt to be a flexible and powerful study tool.
  ...
  * **📝 Notes:**
      * Take notes for each section of the handbook.
      * Notes are saved locally and are available for each level.
...
### Libraries
  ...
  * [wanakana](https://wanakana.com/) - A library for converting between Hiragana, Katakana, and Romaji.

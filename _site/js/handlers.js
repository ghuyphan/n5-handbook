...
export async function changeTab(tabName, buttonElement, suppressScroll = false, fromHistory = false, forceRender = false) {
    ...
    if (isDataTab) {
        ...
        // FIX: Removed newTabContentEl.innerHTML = '' to prevent clearing the container.
        // The handleExternalSearch and updateExternalSearchTab functions will now manage the content.
